...
CreditsSection:AddLabel("Made by: ERIKXVI#7462")
...
if identifyexecutor then
	...
	if not supported then
		client:console("This executor is not supported. If you believe it will, contact ERIKXVI#7462")
        client:console("If you want a free one that kinda supports it, use krnl.")
		return
	end
end
-- !! CANCER BELOW !! --
...
client:console("Bozohub loaded in " .. tostring(tick() - start) .. "ms")
